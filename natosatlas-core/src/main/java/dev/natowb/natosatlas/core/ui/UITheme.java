package dev.natowb.natosatlas.core.ui;
...
public final class UITheme {
    ...
    public static final int BUTTON_BORDER = ELEMENT_BORDER;
    public static final int BUTTON_BORDER_HOVER = ELEMENT_BORDER_HOVER;
    ...
    public static final int TEXTFIELD_BG = ELEMENT_BG;
    public static final int TEXTFIELD_BORDER = 0x00000000;
