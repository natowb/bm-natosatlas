...
public class MapExistingGenerator {
    ...
    public static void generateClientRegions() {
        ...
        NARegionGenerator generator = new NARegionGenerator(regions, access::getChunkFromDisk, MapExistingGenerator::buildOutputFile);
